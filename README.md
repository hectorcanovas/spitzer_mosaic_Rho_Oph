...
* Methods: 
 1.- Run IDL codes (NASA/IDL_Pro library & my codes tools). Examples are given at the header of each code.
 A directory named "idl_results" storing the created fit files will be automatically created.
